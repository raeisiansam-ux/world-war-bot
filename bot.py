...
BOT_TOKEN = os.environ.get("BOT_TOKEN", "1610685733:rWgWdD7Zyka0PdyDvqKtewTuqFRPRxsd7rM")
BASE_URL = f"https://tapi.bale.ai/bot{BOT_TOKEN}/"
PAYMENT_TOKEN = os.environ.get("PAYMENT_TOKEN", "توکن پرداخت هم بزن اینجا")
PAYMENT_TEST_TOKEN = "WALLET-TEST-1111111111111111"

# آیدی عددی ادمین اصلی (همیشه دسترسی کامل دارد)
MAIN_ADMIN_ID = int(os.environ.get("MAIN_ADMIN_ID", "223726163"))

# کانال و گروه اجباری
FORCE_CHANNEL = "@lantern_war_game"
FORCE_GROUP = "@lantern_war_group"
